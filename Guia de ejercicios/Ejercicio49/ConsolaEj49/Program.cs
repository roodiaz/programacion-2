...
namespace Ejercicio46
{
    class Program
    {
        ...
        {
            Competencia <VehiculoDeCarrera> CompetenciaAutos = new Competencia<VehiculoDeCarrera>(10, 8, Competencia<VehiculoDeCarrera>.TipoCompetencia.F1);
            Competencia <VehiculoDeCarrera> CompetenciaMotos = new Competencia<VehiculoDeCarrera>(8, 10, Competencia<VehiculoDeCarrera>.TipoCompetencia.MotoCross);
